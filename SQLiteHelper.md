...
namespace WeChatClient
{
    ...
    public class SQLiteHelper
    {
        ...
        public static DataTable ExecuteDataTable(string connectionString, string commandText, object[] paramList)
        {
            DataSet ds = ExecuteDataSet(connectionString, commandText, paramList);
            return ds?.Tables[0];
        }
